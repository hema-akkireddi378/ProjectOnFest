                    ...
                    <nav className="footernav">
                        <ul className="footerul">
                            <div className="admin-list">
                                ...
                                <li ><Link to="/EventCoordinatorDB" className="admin-links">Event Coordinator Dashboard</Link></li>
                                <li><Link to="/Assignment" className="admin-links">Voolenter's Assignment</Link></li>
                                <li ><Link to="/Support" className="admin-links">Support & QA</Link></li>
                                <li><Link to="/Certificate" className="admin-links">Certificate Download</Link></li>
                            </div>
