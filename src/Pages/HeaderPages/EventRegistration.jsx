...
export function ProCoderRegistration(){
    return(
        <div className="eventsregistration">
          
                <p className="eventContentHeader">Pro Coder Registration Form</p>
...
export function GuessTheOutputRegistration(){
    return(
        <div className="eventsregistration">
...
export function QuizRegistration(){
 ...
 export function EssayWritingRegistration(){
    return(
        <div className="eventsregistration">
...
export function MensCricketRegistration(){
    return(
        <div className="eventsregistration">
...
export function MensKabaddiRegistration(){
    return(
        <div className="eventsregistration">
...
export function MensKhoKhoRegistration(){
    return(
       <div className="eventsregistration">
...
export function MensVolleyBallRegistration(){
    return(
        <div className="eventsregistration">
...
export function CarromBoardRegistration(){
    return(
        <div className="eventsregistration">
...
export function FreeFireRegistration(){
    return(
        <div className="eventsregistration">
...
export function PubgRegistration(){
    return(
       <div className="eventsregistration">
...
export function WomensThrowBallRegistration(){
    return(
        <div className="eventsregistration">
