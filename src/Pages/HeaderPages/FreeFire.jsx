...
export default function FreeFire() {
    return (
        <div>
            ...
            <img className="sports-image" src="https://dl.dir.freefiremobile.com/common/web_event/hash/54f31449f5f91cf0cc223cc635cd5952jpg" alt="Fest image" height="600px" width="80%"></img>
