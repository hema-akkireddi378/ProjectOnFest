...
export default function MensCricket() {
    return (
        <div>
            ...
            <img className="sports-image" src="https://www.shutterstock.com/image-photo/mumbai-india-october-2-2021-600nw-2085546409.jpg" alt="Fest image" height="600px" width="80%"></img>
