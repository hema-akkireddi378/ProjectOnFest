export default function CulturalEvents() {
    return (
        <div>
            ...
            <img className="cultural-images" src="https://tse4.mm.bing.net/th?id=OIP.1lW_70Y22TsqfK0ZR75qdgHaFj&pid=Api&P=0&h=180" alt="Fest image" height="200px" width="80%"></img>
